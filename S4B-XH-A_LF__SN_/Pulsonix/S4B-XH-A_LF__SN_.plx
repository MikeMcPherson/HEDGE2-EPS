...
(library Library_1
	...
	(patternDef "S4BXHALFSN" (originalName "S4BXHALFSN")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt -3.750, 3.450) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt 2.45 -2.3) (pt -9.95 -2.3) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -9.95 -2.3) (pt -9.95 9.2) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -9.95 9.2) (pt 2.45 9.2) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 2.45 9.2) (pt 2.45 -2.3) (width 0.025))
		)
	...
	(compDef "S4B-XH-A_LF__SN_" (originalName "S4B-XH-A_LF__SN_") (compHeader (numPins 4) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://www.mouser.co.uk/ProductDetail/JST-Commercial/S4B-XH-ALFSN?qs=QpmGXVUTftEyAvx%252Br33AyQ%3D%3D&srsltid=AfmBOopXgwHK5vQKy207Eg2VBdixziHXVBrLkW0Mvqq_XGzuQb0VSmKc")
		(attr "<Component Height>" "7")
		(attr "<STEP Filename>" "S4B-XH-A_LF__SN_.stp")
		(attr "<STEP Offsets>" "X=-3.75;Y=3.45;Z=2")
