SamacSys ECAD Model
313750/373961/2.50/8/4/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "SN65HVD1782QDRQ1" (originalName "SN65HVD1782QDRQ1")
	...
	(compDef "SN65HVD1782QDRQ1" (originalName "SN65HVD1782QDRQ1") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "R") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "RE") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "DE") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SN65HVD1782QDRQ1"))
		...
		(attr "Manufacturer_Part_Number" "SN65HVD1782QDRQ1")
		(attr "Mouser Part Number" "595-SN65HVD1782QDRQ1")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/SN65HVD1782QDRQ1?qs=8%2FmU9qzJpL8mmEwMbjC79g%3D%3D")
		(attr "Arrow Part Number" "SN65HVD1782QDRQ1")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/sn65hvd1782qdrq1/texas-instruments?region=nac")
		(attr "Description" "Automotive Fault-Protected RS-485 Transceivers with 3.3-V to 5-V Operation")
		(attr "Datasheet Link" "http://www.ti.com/lit/ds/symlink/sn65hvd1782-q1.pdf")
		(attr "Height" "1.75 mm")
	)
